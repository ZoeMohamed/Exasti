...
export const KATALOG_PASAR: Record<string, DefinisiPasar> = {
  ...
  "Cabai Rawit Hijau": { namaTampil: "Cabai rawit", alias: ["cabai rawit", "cabe rawit", "rawit", "cabai rawit hijau", "cabe rawit ijo"], satuanDasar: "kg" },
  ...
  "Bawang Merah Ukuran Sedang": { namaTampil: "Bawang merah", alias: ["bawang merah", "bwg merah", "brambang", "brambang jawa"], satuanDasar: "kg" },
